...
const login = async (req, res) => {
    ...
    try {
        ...
        res.cookie('session', accessToken, {maxAge: 60*60*1000, httpOnly: true, sameSite: 'None', secure: true, domain: 'entregafinalbackendchback-production.up.railway.app'}).send({ status: 'success', accessToken });
    } catch (e) {
        switch (e.code) {
